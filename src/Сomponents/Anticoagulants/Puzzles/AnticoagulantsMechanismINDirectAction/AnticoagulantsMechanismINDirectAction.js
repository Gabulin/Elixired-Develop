            ...
            {progress >= 50 && (
              <>
                <div className="puzzle__task_sub-text">
                  <TextTyper>
                    <p>
                      Работают через витамин K, благодаря нему карбоксилируются
                      факторы свертывания 2,7,9,10 и противосвертывания C и S.
                    </p>
                  </TextTyper>
                </div>
                <div className="puzzle__task_sub-text">
                  <TextTyper>
                    <p>
                      Антагонисты витамина К обладают с ними структурным
                      сходством и блокируют НАДН-эпоксиредуктазу. Работает не
                      сразу, есть латентный период, так как есть уже
                      закарбоксилированные факторы свертывания. По началу
                      свертываемость крови может даже повысится из-за того что
                      протеины C и S выводятся быстрее.
                    </p>
                  </TextTyper>
                </div>
                <div className="puzzle__task_sub-text">
