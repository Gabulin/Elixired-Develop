  ...
  return (
    <div className="puzzle__main_container">
      <h2 className="puzzle__name">
        МЕХАНИЗМЫ ДЕЙСТВИЯ АНТИКОАГУЛЯНТОВ НЕПРЯМОГО ДЕЙСТВИЯ
      </h2>
          ...
          <div className="puzzle__workspace_panel">
            ...
            {progress >= 50 && (
              <>
                <img
                  className="fade-in back_step"
                  src={INDirectMechStepOneOne}
                  alt=""
                ></img>
                {showSecondImage && (
                  <img
                    className="fade-in back_step"
                    src={INDirectMechStepOneTwo}
                    alt=""
                  ></img>
                )}
                <div
          ...
          <div className="puzzle__inform-click_textarea">
              ...
              <>
                <div className="fade-in">
                  <p className="puzzle__task_sub-text">
                    <strong>Антикоогулянты непрямого действия:</strong>
                  </p>
                  <p className="puzzle__task_sub-text">
                    - Производные 4-оксикумарина:
                    <strong> варфарин и аценокумарол</strong>
                  </p>
                  <p className="puzzle__task_sub-text">
                    - Производное инандиона:<strong> фенидион</strong>
                  </p>
                  <p className="puzzle__task_sub-text">
                    Эти препараты являются{" "}
                    <strong>антагонистами витамина К</strong>, нарушают синтез
                    функционально активных факторов коагуляции{" "}
                    <strong>II (протромбин), VII, IX и X,</strong> дополнительно
                    протеин C и S в печени.
                  </p>
                </div>
              </>
            )}
            {progress === 100 && (
              <>
                <div className="fade-in">
                  <p className="puzzle__task_sub-text">
                    Они действует через <strong>ингибирование эпоксидной редуктазы
                    витамина К,</strong> вследствие чего фермент у-глутамилкарбоксилаза
                    не активируется → из-за этого предшественники факторов
                    свертывания не карбоксилируются → биологически активные
                    факторы свертывания не образуются.
                  </p>
                  <p className="puzzle__task_sub-text">
                    <strong>Показания:</strong> длительная профилактика и лечение венозного
                    тромбоза и тромбоэмболий.
                  </p>
                  <p className="puzzle__task_sub-text">
                    <strong>Побочные эффекты:</strong> кровотечения, диспепсия, риск рикошетного
                    тромбоза при резкой отмене, гепатит, поражение почек.
                  </p>
                  <p className="puzzle__task_sub-text">
                    <strong>Противопоказания:</strong> беременность (выраженный тератогенный
                    эффект), лактация, кровотечения или их риск, нарушение
                    печени и почек, гиперчувствительность.
                  </p>
                </div>
              </>
            )}
