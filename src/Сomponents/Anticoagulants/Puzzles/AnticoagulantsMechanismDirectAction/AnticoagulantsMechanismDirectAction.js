          ...
          <div className="puzzle__inform-click_textarea">
            ...
            {progress === 20 && (
              <>
                <div className="puzzle__task_sub-text">
                  <TextTyper>
                    <p><b>Дабигатрана этексилат</b>- обратимо присоединяется к активному центру тромбина, нарушая его активность. Низкая биодоступность, повышается в кислой среде. Поэтому не приминяют с ингибиторами протонной помпы. В печени и крови образуется активный дабигатран.</p>
                  </TextTyper>
                </div>
                <div className="puzzle__task_sub-text">
                  <TextTyper>
                    <p>Показания: профилактика тромбоза вен нижних конечностей, таза, и ТЭЛА, эмболии при ФП.</p>
                  </TextTyper>
                </div>
                ...
                <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                  <TextTyper>
                    <p>Противопоказания: активное кровотечение</p>
                  </TextTyper>
                </div>
            ...
            {progress === 40 && (
              ...
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Ривароксабан - обратимо блокирует фактор Xa(Стюарта-Прауэра). </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Биодоступность 60-80%.</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Окисляется в печени, выводится с мочой. ПЭ=10ч. </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Назначается внутрь.  </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Показания: вторичная профилактика ИМ и тромбоза сосудистого стента, профилактика тромбоза вен.</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Противопоказания: активные кровотечения, язва желудка, заболевания печени с коагулопатией.</p>
                </TextTyper>
              </div>
            ...
            {progress === 60 && (
              ...
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Апиксабан- обратимо блокирует Xa. ПЭ=3ч. </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Показания: профилактика венозной тромбоэмболии, предупреждение инсульта, тромбоэмболии при ФП, лечение ТЭЛА.</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Общие противопоказания: активное кровотечение, механические протезы клапанов сердца и митральным стенозом
(Есть данные что наоборот увеличивает их тромбоз).</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Если кровотечение на фоне передозировки -нужно пополнить плазменные факторы, перелить свежезамороженную плазму.</p>
                </TextTyper>
              </div>
            ...
            {progress >= 80 && (
              ...
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Гепарин= ГАГ(Глюкозаминогликаны + пентасахарид) </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Есть нефракционированный Гепарин (Гепарин натрия) и низкомолекулярный Гепарин(НМГ).</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Отличие в том, что часть ГАГ у НМГ короче, что не позволяет влиять на тромбин.</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Гепарин работает через плазменный полипептид антитромбин III, который активируется при связывании с пентасахаридом гепарина. Активированный комплекс связывает тромбин. </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Т.к НМГ короче, то он может связать только фактор Xa. Захватить тромбин не получается. </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text">
                <TextTyper>
                  <p>Протеолиз тромбина- антитромботическое и противосвертывающее действие</p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Протеолиз Xa – антитромботическое действие. </p>
                </TextTyper>
              </div>
              <div className="puzzle__task_sub-text" style={{ marginTop: "2px" }}>
                <TextTyper>
                  <p>Соответственно, если гепарин работает через антитромбин III, то если его не будет, человек будет резистентен к действию гепарина.</p>
                </TextTyper>
              </div>
